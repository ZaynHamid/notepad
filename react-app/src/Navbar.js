    ...
    <Disclosure as="nav" className="bg-gray-800">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            ...
            >
              <g>
                <path
                  d="M236.182,0c35.976,0,69.617,9.99,98.306,27.343c-55.09,33.321-91.917,93.799-91.917,162.88
		...
		S131.125,0,236.182,0z"
                />
                <path
                  d="M236.189,0.003c5.8,0,11.54,0.26,17.2,0.77c-96.95,8.74-172.93,90.22-172.93,189.45
		...
		S131.129,0.003,236.189,0.003z"
            ...
            >
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                {user ?   
                  ...
                  <div>
                    <MenuButton className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <h2 className='text-white capitalize text-xl'>{user}</h2>
                    </MenuButton>
                  </div>
                  <Transition
                ...
                </Menu> : <div className='sm:block hidden'>
                <Link to="/login">
                       <button className="ml-3 text-black px-4 py-2 rounded-xl hover:bg-white transition-all bg-white/60 ">
                         Login
                       </button>
                    </Link>
          ...
          <DisclosurePanel className="sm:hidden">
            <div className="space-y-1 px-4 pb-3 pt-2 flex items-center gap-4">
            <svg
              width={18}
              className="cursor-pointer"
              height={18}
		...
		S131.129,0.003,236.189,0.003z"
            ...
            {!user ? <div className='block sm:hidden py-4'>
                <Link to="/login">
                       <button className="ml-3 text-black px-4 sm:py-2 py-1 rounded-xl hover:bg-white transition-all bg-white/60 ">
                         Login
                       </button>
                    </Link>
